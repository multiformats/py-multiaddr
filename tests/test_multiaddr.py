...
@pytest.mark.parametrize(
    ...
    ["/ip4",
     ...
     "/zeronet/MwFP3qbRbTf3D",
     "/zeronet/1HeLLo4uzjaLetFMbTx6NH3R3PfMwFP3qbwFPbTf3D",
     "/zeronet/11HellO4uzjaletFMbTx6NH3R3PfMwFP3qbwFPbTf3D",
     "/udp/1234/sctp",
     "/udp/1234/udt/1234",
     "/udp/1234/utp/1234",
...
@pytest.mark.parametrize(
    ...
    ["/ip4/1.2.3.4",
     ...
     "/zeronet/1z86z5jCaCQpgabfbQFJTLcKBLJdTtGYD",
     "/udp/0",
     "/tcp/0",
     "/sctp/0",
     "/udp/1234",
